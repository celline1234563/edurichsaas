-- ============================================
-- EduRichSaaS Database Schema (Clean Version)
-- ============================================
...
DROP POLICY IF EXISTS "Users can view evaluations of their students" ON evaluations;
DROP POLICY IF EXISTS "Users can insert evaluations for their students" ON evaluations;
DROP POLICY IF EXISTS "Users can view scores of their students" ON scores;
DROP POLICY IF EXISTS "Users can insert scores for their students" ON scores;
DROP POLICY IF EXISTS "Users can view reports of their students" ON reports;
DROP POLICY IF EXISTS "Users can create reports for their students" ON reports;
...
ALTER TABLE daily_simple_logs ENABLE ROW LEVEL SECURITY;
ALTER TABLE auto_collected_data ENABLE ROW LEVEL SECURITY;
